...
async def test_approve_request_success(db_session: AsyncSession, mock_xui_api, mock_hiddify_api):
    ...
    args, kwargs = mock_xui_api.add_client_to_all_inbounds.call_args
    assert args[0] == user.username  # Email generated by generate_client_name
    assert args[2] == "vless"  # Protocol
